...
Для выполнения пункта 3 была написана функция `count_total_data`, которая считает агрегированные данные всех магазинам по штатам и годам и выводит их в отдельный файл total_data.csv.
...
* Первый и второй пункты задания.
* Написание README.
