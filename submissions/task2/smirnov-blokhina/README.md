...
### Подход к решению
 ...
 4. Обучение модели ARIMA с параметрами p,d,q.
 4. Подбор параметров p1, q1 проводился перебором с помощью кросс-валидации. Сравнение моделей производилось с помощью информационного критерия Акаике. 
 5. Обучение модели SARIMAX с параметрами p1,d,q1 полученными из графиков функции автокореляции и частичной автокореляции.  Сравнение полученных моделей ARIMA и SARIMAX проводилось с помощью информационного критерия Акаике.
