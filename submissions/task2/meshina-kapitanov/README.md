...
* На примере временного ряда увидели, что
	* Для аддитивной модели
	    ...
	    2. Cезональность обладает стационарностью
...
> Для построения модели ARIMA, SARIMAX
* 5	Sklearn.metrics
...
2. Разложение модели на тренд, сезональность и остаток для аддитивной модели
3. ARIMA модель
...
2. Поиск коэффициента интегрированности ряда
3. Подбор параметров с использованием функций автокорреляции и частичной автокорреляции
4. Разложение модели на тренд, сезональность и остаток для мультипликативной модели
